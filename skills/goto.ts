/**
 * @skill goto
 * @description Navigate to coordinates with chunked pathfinding and manual fallback
 * @tags navigation, movement
 */

// Chunked pathfinding with manual fallback. Breaks long paths into ~20 block legs.
